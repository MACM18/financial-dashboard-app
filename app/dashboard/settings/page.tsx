...
export default function SettingsPage() {
    ...
    try {
      ...
      if (prefs) {
        setPreferences({
          ...
          goalReminders: prefs.notifications ?? true,
          paymentDue: prefs.budget_alerts ?? true,
  ...
  const savePreferences = async () => {
    ...
    try {
      ...
      await userPreferencesService.createOrUpdateUserPreferences(user.id, {
        currency: preferences.currency,
        theme: preferences.theme,
        notifications: preferences.goalReminders,
